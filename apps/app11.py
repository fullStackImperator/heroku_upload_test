    ...
    html.Div([  # page 1
        ...
        html.Div([  # subpage 1
            ...
            html.Div([
                ...
                html.Div([
                    html.H5(
                        'Breidenbach von Schlieffen Multi Manager - Strategie Ausgewogen'),
                    html.H6('www.digitalesfamilyoffice.de',
                            style={'color': '#7F90AC'}),
                ], className="nine columns padded"),

                html.Div([
                    html.H1(
                        [html.Span('11', style={'opacity': '0.5'}), html.Span('17')]),
                    html.H6('Monatliches Update')
            ...
            html.Div([
                ...
                html.Div([
                    ...
                    html.P('The fund is designed for investors who are looking for a flexible \
                            ...
                            than BvS MMS Ausgewogen.', className='blue-text'),
